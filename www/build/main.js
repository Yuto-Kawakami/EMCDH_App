            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { 'bool': true, 'name': credential.user.displayName }];
                    case 2:
                        err_1 = _a.sent();
                        console.log(err_1);
                        return [2 /*return*/, { 'bool': false }];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fb.login(perms)
                                .then(function (response) {
                                var facebookCredential = __WEBPACK_IMPORTED_MODULE_7_firebase___default.a.auth.FacebookAuthProvider
                                    .credential(response.authResponse.accessToken);
                                return __WEBPACK_IMPORTED_MODULE_7_firebase___default.a.auth().signInWithCredential(facebookCredential)
    ...
    StartPage.prototype.loginFacebook = function () {
        ...
        if (this.platform.is('cordova')) {
            ...
            this.nativeFacebookLogin().then(function (res) {
                // console.log(res);
                if (res.bool) {
                    _this.auth.snsLogin(res.name).subscribe(function (allowed) {
                        if (allowed) {
